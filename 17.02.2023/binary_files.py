...
with open("17.02.2023/test.jpg", "rb") as f:#для открытия картинок всегда использовть команды по типу rb
    # print(f.read(15))#пытаемся прочитать первые 15 символов картинки jpg
    with open("17.02.2023/test-copy.jpg","wb") as w:#открывается 1 опеном файл а 2ой уже перезаписывает в новый файл
